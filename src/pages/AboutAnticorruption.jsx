...
export default function AboutAnticorruption() {
  ...
  const content = {
    ru: {
      ...
      mainText:
        "В Городской поликлинике №33 проводится целенаправленная работа по противодействию коррупции и формированию антикоррупционной культуры. Мы придерживаемся принципа «Нулевой терпимости» к любым правонарушениям.",
      helplineTitle: "Телефон доверия / Служба комплаенс",
      helplineText:
        "Если вы столкнулись с фактами коррупции, вымогательства или неэтичного поведения со стороны сотрудников поликлиники, просим незамедлительно сообщить:",
      ...
      links: [
        ...
        {
          title:
            "Об утверждении Типового антикоррупционного стандарта поведения",
    ...
    kz: {
      ...
      mainText:
        "№33 Қалалық емханада сыбайлас жемқорлыққа қарсы іс-қимыл және сыбайлас жемқорлыққа қарсы мәдениетті қалыптастыру бойынша мақсатты жұмыстар жүргізілуде. Біз кез келген құқық бұзушылыққа «Мүлдем төзбеушілік» қағидатын ұстанамыз.",
      helplineTitle: "Сенім телефоны / Комплаенс қызметі",
      helplineText:
        "Егер сіз емхана қызметкерлері тарапынан сыбайлас жемқорлық, бопсалау немесе әдепсіз мінез-құлық фактілеріне тап болсаңыз, дереу хабарлауыңызды сұраймыз:",
      ...
      links: [
        ...
        {
          title:
            "Сыбайлас жемқорлыққа қарсы мінез-құлықтың үлгілік стандартын бекіту туралы",
          url: "https://adilet.zan.kz/rus/docs/V2000021890",
        },
        {
          title:
            "ҚР Сыбайлас жемқорлыққа қарсы саясатының 2022–2026 жылдарға арналған тұжырымдамасы",
          url: "https://adilet.zan.kz/rus/docs/U2200000802",
        },
      ],
    },
        ...
        <div className="bg-white max-w-4xl">
          ...
          <div className="space-y-4">
            {t.links.map((link, idx) => (
              ...
              >
                <FileText
                  className="text-gray-400 group-hover:text-teal-600 mr-3"
                  size={24}
                />
