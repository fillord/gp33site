  ...
  const t = {
    ...
    empty:
      lang === "ru"
        ...
        : "Қазіргі уақытта бос жұмыс орындары жоқ.",
      ...
      <div className="bg-teal-50 border border-teal-100 rounded-xl p-6 mb-10 flex flex-col md:flex-row justify-between items-center text-center md:text-left">
        <div>
          ...
          <p className="text-gray-600">
            Присылайте резюме на почту или звоните
          </p>
        </div>
        <div className="mt-4 md:mt-0 font-bold text-teal-700 text-lg">
          <a href={`tel:${t.phone}`} className="mr-4 hover:underline">
            {t.phone}
          </a>
              ...
              >
                ...
                <div className="p-6 flex flex-col md:flex-row justify-between items-center gap-4">
                  <div className="flex items-center w-full md:w-auto">
                    <div
                      className={`p-3 rounded-full mr-4 transition-colors ${isOpen ? "bg-teal-100 text-teal-700" : "bg-gray-100 text-gray-500"}`}
                    >
                      <Briefcase size={24} />
                    </div>
