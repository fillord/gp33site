...
export default function AboutSphere() {
  ...
  const content = {
    ru: {
      ...
      mainText:
        "КГП на ПХВ «Городская поликлиника №33» оказывает амбулаторно-поликлиническую помощь взрослому и детскому населению по следующим специальностям:",
      services: [
    ...
    kz: {
      ...
      mainText:
        "«№33 қалалық емхана» ШЖҚ КМК ересектер мен балаларға келесі мамандықтар бойынша амбулаториялық-емханалық көмек көрсетеді:",
      services: [
