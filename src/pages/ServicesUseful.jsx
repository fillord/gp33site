  ...
  const t = {
    breadcrumb:
      lang === "ru"
        ...
        : "БАСТЫ БЕТ / ПАЙДАЛЫ АҚПАРАТ",
    title:
      lang === "ru"
        ? "Полезная информация для пациентов"
        : "Пациенттерге арналған пайдалы ақпарат",
    subtitle:
      lang === "ru"
        ? "Советы по здоровью, ответы на вопросы и важные контакты"
        : "Денсаулық бойынша кеңестер, сұрақтарға жауаптар және маңызды байланыстар",
    ...
    tips: [
      {
        ...
        color: "bg-red-500",
        title: {
          ru: "Профилактика сердечных заболеваний",
          kz: "Жүрек ауруларының алдын алу",
        },
        text: {
    ...
    faqs: [
      {
        q: {
          ru: "Как прикрепиться к поликлинике?",
          kz: "Емханаға қалай тіркелуге болады?",
        },
        a: {
      ...
      {
        q: {
          ru: "Как вызвать врача на дом?",
          kz: "Дәрігерді үйге қалай шақыруға болады?",
        },
        a: {
      ...
      {
        q: {
          ru: "Что такое скрининг и зачем он нужен?",
          kz: "Скрининг дегеніміз не және ол не үшін қажет?",
        },
        a: {
    ...
    links: [
      {
        name: "Egov.kz - Электронное правительство",
        url: "https://egov.kz",
        icon: Globe,
      },
      {
        name: "Fms.kz - Фонд медстрахования",
        url: "https://fms.kz",
        icon: Shield,
      },
      {
        name: "103.kz - Лекарства и аптеки",
        url: "https://103.kz",
        icon: Activity,
      },
    ],
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          {t.tips.map((tip, index) => (
            <div
              key={index}
              className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100 hover:shadow-xl transition group"
            >
              <div
                className={`${tip.color} p-4 flex justify-center items-center h-32 group-hover:scale-105 transition duration-500`}
              >
