...
import { Facebook, Mail, Phone, MessageCircle, Instagram } from "lucide-react";
...
export default function AboutPolicy() {
  ...
  const content = {
    ru: {
      ...
      intro:
        "Добро пожаловать на страницу Антикоррупционной комплаенс-службы КГП на ПХВ «Городская поликлиника №33» Управления общественного здравоохранения города Алматы.",
      ...
      callToAction:
        "Если Вы столкнулись с фактом нарушения законодательства Республики Казахстан о противодействии коррупции, в том числе нормативных правовых актов уполномоченного органа и этических норм, Вы можете сообщить об этом в Антикоррупционную комплаенс-службу, по номеру: +7 (***) ***-**-**",
    ...
    kz: {
      ...
      intro:
        "Алматы қаласы Қоғамдық денсаулық сақтау басқармасының «№33 қалалық емхана» ШЖҚ КМК Сыбайлас жемқорлыққа қарсы комплаенс-қызметінің парақшасына қош келдіңіздер.",
      ...
      callToAction:
        "Егер Сіз Қазақстан Республикасының сыбайлас жемқорлыққа қарсы іс-қимыл туралы заңнамасын, оның ішінде уәкілетті органның нормативтік құқықтық актілерін және әдеп нормаларын бұзу фактісіне тап болсаңыз, бұл туралы Сыбайлас жемқорлыққа қарсы комплаенс-қызметіне +7 (***) ***-**-** нөмірі бойынша хабарлай аласыз.",
        ...
        <div className="bg-white max-w-5xl">
          ...
          <div className="mt-12 flex space-x-3">
            ...
            <a
              ...
              className="w-10 h-10 bg-[#3b5998] text-white rounded flex items-center justify-center hover:opacity-90 transition"
            >
              <Instagram size={20} />
            </a>
            {/* VK */}
            ...
            <a
              ...
              className="w-10 h-10 bg-[#25d366] text-white rounded flex items-center justify-center hover:opacity-90 transition"
            >
            ...
            <a
              ...
              className="w-10 h-10 bg-[#dd4b39] text-white rounded flex items-center justify-center hover:opacity-90 transition"
            >
              <Mail size={20} />
            </a>
          </div>
