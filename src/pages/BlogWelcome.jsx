...
export default function BlogWelcome() {
  ...
  const content = {
    ru: {
      ...
      quote:
        "Здоровье нации — это наше главное богатство. Мы работаем для того, чтобы качественная медицина была доступна каждому жителю нашего района.",
      text: [
    ...
    kz: {
      ...
      quote:
        "Ұлт денсаулығы — біздің басты байлығымыз. Біз сапалы медицинаның ауданымыздың әрбір тұрғынына қолжетімді болуы үшін жұмыс істейміз.",
      text: [
        ...
        <div className="bg-white rounded-xl shadow-xl overflow-hidden max-w-[95%] mx-auto flex flex-col md:flex-row">
          ...
          <div className="md:w-1/2 p-8 md:p-12 flex flex-col">
            ...
            <div className="bg-teal-50 border-l-4 border-teal-500 p-6 mb-8 rounded-r-lg italic text-gray-700 relative">
              <Quote
                className="absolute top-2 left-2 text-teal-200 transform -scale-x-100"
                size={40}
              />
            ...
            <div className="prose text-gray-600 leading-relaxed mb-8 text-lg">
              {t.text.map((paragraph, idx) => (
                <p
                  key={idx}
                  className={
                    idx === 0 ? "font-bold text-gray-800 mb-4" : "mb-4"
                  }
                >
                  {paragraph}
                </p>
