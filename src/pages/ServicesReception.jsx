    ...
    schedule: [
      {
        ...
        days: { ru: "Среда", kz: "Сәрсенбі" },
        time: "14:00 - 16:00",
        room: "301"
      },
      {
        name: { ru: "Искакова Айгуль Сериковна", kz: "Искакова Айгүл Серікқызы" },
        role: { ru: "Зам. директора по лечебной части", kz: "Директордың емдеу ісі жөніндегі орынбасары" },
        days: { ru: "Вторник, Четверг", kz: "Сейсенбі, Бейсенбі" },
        time: "10:00 - 12:00",
        room: "302"
      },
      {
        name: { ru: "Ахметова Динара Канатовна", kz: "Ахметова Динара Қанатқызы" },
        role: { ru: "Главный бухгалтер", kz: "Бас есепші" },
        days: { ru: "Понедельник", kz: "Дүйсенбі" },
        time: "15:00 - 17:00",
        room: "305"
      },
      {
        name: { ru: "Бекмуратова Сауле Асановна", kz: "Бекмұратова Сәуле Асанқызы" },
        role: { ru: "Главная медсестра", kz: "Бас мейірбике" },
        days: { ru: "Ежедневно", kz: "Күнделікті" },
        time: "09:00 - 17:00",
        room: "201"
      }
    ],
