...
export default function ServicesReception() {
  ...
  const t = {
    breadcrumb:
      lang === "ru"
        ? "ГЛАВНАЯ / ПРИЕМ ГРАЖДАН"
        : "БАСТЫ БЕТ / АЗАМАТТАРДЫ ҚАБЫЛДАУ",
    title:
      lang === "ru"
        ? "График приема граждан администрацией"
        : "Әкімшіліктің азаматтарды қабылдау кестесі",
    subtitle:
      lang === "ru"
        ? "Предварительная запись на прием осуществляется через приемную или колл-центр"
        : "Қабылдауға алдын ала жазылу қабылдау бөлмесі немесе колл-орталығы арқылы жүзеге асырылады",
    ...
    schedule: [
      {
        name: {
          ru: "Абдрасилов Гани Болатович",
          kz: "Абдрасилов Ғани Болатұлы",
        },
    ...
    infoTitle:
      lang === "ru" ? "Порядок записи на прием" : "Қабылдауға жазылу тәртібі",
    infoText:
      lang === "ru"
      ...
      <div className="container mx-auto px-4 py-12">
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-teal-50 text-teal-800 text-sm uppercase tracking-wider">
                  <th className="p-6 border-b border-teal-100">
                    {t.tableHeaders.name}
                  </th>
                  <th className="p-6 border-b border-teal-100">
                    {t.tableHeaders.day}
                  ...
                  <th className="p-6 border-b border-teal-100 text-center">
                    {t.tableHeaders.room}
                  </th>
                </tr>
              </thead>
        ...
        <div className="bg-blue-50 rounded-xl p-8 border-l-4 border-blue-500 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="max-w-2xl">
            ...
            <p className="text-blue-800/80">{t.infoText}</p>
          </div>
