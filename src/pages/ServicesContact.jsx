...
export default function ServicesContact() {
  ...
  const content = {
    ru: {
      breadcrumb:
        "ГЛАВНАЯ СТРАНИЦА / ЕДИНЫЙ КОНТАКТ-ЦЕНТР ДЛЯ КОНСУЛЬТАЦИИ ПО УСЛУГАМ",
    ...
    kz: {
      breadcrumb:
        "БАСТЫ БЕТ / ҚЫЗМЕТТЕР БОЙЫНША КЕҢЕС БЕРУГЕ АРНАЛҒАН БІРЫҢҒАЙ БАЙЛАНЫС ОРТАЛЫҒЫ",
      title:
        "ҚЫЗМЕТТЕР БОЙЫНША КЕҢЕС БЕРУГЕ АРНАЛҒАН БІРЫҢҒАЙ БАЙЛАНЫС ОРТАЛЫҒЫ",
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="bg-white max-w-5xl">
          ...
          <div className="text-blue-700 text-xl md:text-2xl font-medium mb-4 flex flex-col md:flex-row gap-2 md:gap-4">
            <a href="tel:1414" className="hover:underline">
              1414
            </a>
            <span className="hidden md:inline text-gray-400">|</span>
            <a href="tel:88000807777" className="hover:underline">
              8-800-080-7777
            </a>
          </div>
