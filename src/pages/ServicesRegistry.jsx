...
export default function ServicesRegistry() {
  ...
  const t = {
    breadcrumb:
      lang === "ru"
        ? "ГЛАВНАЯ / РЕЕСТР ГОСУСЛУГ"
        : "БАСТЫ БЕТ / МЕМЛЕКЕТТІК ҚЫЗМЕТТЕР ТІЗІЛІМІ",
    title:
      lang === "ru"
    ...
    subtitle:
      lang === "ru"
        ? "Перечень услуг, оказываемых в рамках ГОБМП и ОСМС"
        : "ТМКЕК және МӘМС шеңберінде көрсетілетін қызметтер тізбесі",
  ...
  const services = [
    ...
    },
    {
      ...
      icon: Activity,
      title: {
        ru: "Запись на прием к врачу",
        kz: "Дәрігердің қабылдауына жазылу",
      },
    ...
    },
    {
      ...
      icon: UserPlus,
      title: {
        ru: "Прикрепление к медицинской организации, оказывающей ПМСП",
        kz: "МСАК көрсететін медициналық ұйымға тіркелу",
      },
    ...
    },
    {
      ...
      icon: FileCheck,
      title: {
        ru: "Выдача справки с медицинской организации, оказывающей ПМСП",
        kz: "МСАК көрсететін медициналық ұйымнан анықтама беру",
      },
    ...
    },
    {
      ...
      icon: ClipboardList,
      title: {
        ru: "Выдача листа о временной нетрудоспособности (Больничный)",
        kz: "Уақытша еңбекке жарамсыздық туралы парақты беру",
      },
    ...
    },
    {
      ...
      icon: FileText,
      title: {
        ru: "Выдача справки о временной нетрудоспособности",
        kz: "Уақытша еңбекке жарамсыздық туралы анықтаманы беру",
      },
      link: "#", // Выдается врачом
    },
    {
      ...
      icon: FileText,
      title: {
        ru: "Выдача выписки из медицинской карты стационарного больного",
        kz: "Стационарлық науқастың медициналық картасынан көшірме беру",
      },
    ...
    },
    {
      ...
      icon: Activity,
      title: {
        ru: "Добровольное анонимное и обязательное конфиденциальное медобследование на ВИЧ",
        kz: "АИТВ-инфекциясына ерікті және міндетті құпия медициналық тексерілу",
      },
      link: "#", // Очно
    },
    {
      ...
      icon: FileCheck,
      title: {
        ru: "Выдача справки с противотуберкулезной организации",
        kz: "Туберкулезге қарсы ұйымнан анықтама беру",
      },
    ...
    },
    {
      ...
      icon: FileCheck,
      title: {
        ru: "Выдача справки с психоневрологической организации",
        kz: "Психоневрологиялық ұйымнан анықтама беру",
      },
    ...
    },
    {
      ...
      icon: FileCheck,
      title: {
        ru: "Выдача справки с наркологической организации",
        kz: "Наркологиялық ұйымнан анықтама беру",
      },
    ...
    },
    {
      ...
      icon: FileText,
      title: {
        ru: "Прохождение предварительных обязательных медицинских осмотров",
        kz: "Алдын ала міндетті медициналық тексерулерден өту",
      },
      link: "#", // Очно
    },
  ];
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filtered.map((service) => (
            <div
              key={service.id}
              className="bg-white p-6 rounded-xl shadow-sm hover:shadow-lg transition border border-gray-100 flex flex-col h-full group"
            >
