...
export default function StateSymbols() {
  ...
  const t = {
    breadcrumb:
      lang === "ru"
        ? "ГЛАВНАЯ / ГОСУДАРСТВЕННЫЕ СИМВОЛЫ"
        : "БАСТЫ БЕТ / МЕМЛЕКЕТТІК РӘМІЗДЕР",
    title:
      lang === "ru"
    ...
    subtitle:
      lang === "ru"
        ? "Священные атрибуты независимости и суверенитета"
        : "Тәуелсіздік пен егемендіктің қасиетті атрибуттары",
    ...
    emblemAuthor:
      lang === "ru"
        ? "Жандарбек Малибеков, Шота Уалиханов"
      ...
      <div className="container mx-auto px-4 py-16 space-y-20">
        ...
        <div className="bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-100">
          <div className="bg-teal-800 text-white p-8 md:p-12 text-center">
            <Music
              size={48}
              className="mx-auto mb-4 text-yellow-400 opacity-80"
            />
          ...
          <div className="p-8 md:p-12 flex flex-col md:flex-row gap-12">
            ...
            <div className="md:w-2/3 space-y-8">
              {t.anthemLyrics.map((part, index) => (
                ...
                >
                  {part.label && (
                    <h4 className="font-bold text-yellow-700 uppercase mb-3 tracking-wider text-sm">
                      {part.label}
                    </h4>
                  )}
