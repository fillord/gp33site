...
export default function ServicesInfo() {
  ...
  const content = {
    ru: {
        ...
        items: [
          {
            ...
            text: "Диабет, ревматизм, ДЦП полностью перейдут в пакет ОСМС (лекарства и обследования бесплатно).",
          },
          {
            title: "Гипертензия и почки",
            text: "Наблюдение для предотвращения инсультов, гемодиализ и трансплантация.",
          },
          {
            title: "Низкие доходы",
            text: "Граждане категорий D и E будут застрахованы за счет государства.",
          },
          {
            title: "Самозанятые",
            text: "Вход в систему с минимальным взносом (4 250 ₸/мес).",
          },
        ],
      },
      ...
      videoBtn: (
        <a
          href="https://youtu.be/l8ckT3wFDEk"
          target="_blank"
    ...
    kz: {
      ...
      section4: {
        ...
        items: [
          {
            title: "Созылмалы аурулар",
            text: "Диабет, ревматизм, ДЦП толығымен МӘМС пакетіне өтеді (дәрі-дәрмек пен тексеру тегін).",
          },
          {
            title: "Гипертензия және бүйрек",
            text: "Инсульттың алдын алу, гемодиализ және трансплантация.",
          },
          {
            title: "Төмен кірістер",
            text: "D және E санатындағы азаматтар мемлекет есебінен сақтандырылады.",
          },
          {
            title: "Өзін-өзі жұмыспен қамтығандар",
            text: "Жүйеге минималды жарнамен кіру (айына 4 250 ₸).",
          },
        ],
      },
      ...
      <div className="container mx-auto px-4 py-12 max-w-5xl">
        ...
        <section className="bg-white rounded-xl shadow-md p-8 mb-8 border-l-4 border-blue-500">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
            {t.section1.methods.map((method, i) => (
              <div
                key={i}
                className="flex flex-col items-center text-center p-4 bg-gray-50 rounded-lg hover:bg-blue-50 transition"
              >
          ...
          <section className="bg-white rounded-xl shadow-md p-8 border-t-4 border-yellow-400">
            ...
            <div className="space-y-4">
              {t.section3.steps.map((step, i) => (
                ...
                >
                  <span className="font-bold text-yellow-600 mr-3 text-xl">
                    {i + 1}
                  </span>
        ...
        <section className="bg-gradient-to-r from-teal-800 to-teal-700 rounded-xl shadow-lg p-8 text-white">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
            ...
            <span className="bg-yellow-400 text-teal-900 text-xs font-bold px-3 py-1 rounded-full uppercase mt-2 md:mt-0">
              Важно
            </span>
          </div>
