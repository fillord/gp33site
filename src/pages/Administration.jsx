...
export default function Administration() {
  ...
  const t = {
    breadcrumb:
      lang === "ru" ? "ГЛАВНАЯ / АДМИНИСТРАЦИЯ" : "БАСТЫ БЕТ / ӘКІМШІЛІК",
    title: lang === "ru" ? "Руководство поликлиники" : "Емхана басшылығы",
    subtitle:
      lang === "ru"
        ? "Административно-управленческий персонал ГП №33"
        : "№33 ҚЕ әкімшілік-басқару қызметкерлері",
  ...
  const administration = [
    // --- ТОП МЕНЕДЖМЕНТ ---
    {
      ...
      desc: {
        ru: "Организатор здравоохранения высшей категории.",
        kz: "Жоғары санатты денсаулық сақтау ұйымдастырушысы.",
      },
      reception: {
        ru: "Среда, 14:00 - 16:00 (Каб. 301)",
        kz: "Сәрсенбі, 14:00 - 16:00 (301 каб.)",
      },
    ...
    },
    {
      ...
      category: "top",
      role: {
        ru: "Заместитель директора по лечебной части",
        kz: "Директордың емдеу ісі жөніндегі орынбасары",
      },
      name: {
        ru: "ОРЫНОВ АЛМАЗ МЕДЕУХАНОВИЧ",
        kz: "ОРЫНОВ АЛМАЗ МЕДЕУХАНОВИЧ",
      },
      reception: {
        ru: "Вторник, Четверг 10:00 - 12:00",
        kz: "Сейсенбі, Бейсенбі 10:00 - 12:00",
      },
    ...
    },
    {
      ...
      name: {
        ru: "АХМЕТБЕКОВА НУРКАН КАБИЖАНОВНА",
        kz: "АХМЕТБЕКОВА НУРКАН КАБИЖАНОВНА",
      },
      reception: {
        ru: "Понедельник 15:00 - 17:00",
        kz: "Дүйсенбі 15:00 - 17:00",
      },
    ...
    // --- ЗАВЕДУЮЩИЕ ОТДЕЛЕНИЯМИ ---
    {
      ...
      name: {
        ru: "ЖАНГУТДИНОВА НАЗИГУЛЬ САРКЫТБЕКОВНА",
        kz: "ЖАНГУТДИНОВА НАЗИГУЛЬ САРКЫТБЕКОВНА",
      },
      phone: "Вн. 101",
      email: "csz1@gp33.kz",
    ...
    },
    {
      ...
      category: "head",
      role: {
        ru: "Заведующая отделением ЦСЗ-1",
        kz: "ЦСЗ-1 бөлімшесінің меңгерушісі",
      },
      name: {
        ru: "ТӨЛЕБИ АЙНҰР АБДЫҚАДЫРҚЫЗЫ",
        kz: "ТӨЛЕБИ АЙНҰР АБДЫҚАДЫРҚЫЗЫ",
      },
      phone: "Вн. 102",
      email: "csz2@gp33.kz",
      img: "https://via.placeholder.com/150",
    },
    {
      ...
      category: "head",
      role: {
        ru: "Зав. отд. специализированной помощи",
        kz: "Мамандандырылған көмек бөлімшесінің меңгерушісі",
      },
      name: {
        ru: "ДУЙСЕНОВА ГУЛДАНА МАЛКАЙДАРОВНА",
        kz: "ДУЙСЕНОВА ГУЛДАНА МАЛКАЙДАРОВНА",
      },
      phone: "Вн. 104",
      email: "spec@gp33.kz",
      img: "https://via.placeholder.com/150",
    },
    {
      ...
      category: "head",
      role: {
        ru: "Зав. отделением Женской консультации",
        kz: "Әйелдер кеңесі бөлімшесінің меңгерушісі",
      },
      name: {
        ru: "КОИГЕЛДИЕВА АЛИЯ ТУМЕНБАЕВНА",
        kz: "КОИГЕЛДИЕВА АЛИЯ ТУМЕНБАЕВНА",
      },
      phone: "Вн. 105",
      email: "women@gp33.kz",
      img: "https://via.placeholder.com/150",
    ...
    // --- АХЧ И ПРОЧИЕ ---
    {
      ...
      name: {
        ru: "САДАКБАЕВА ГУЛИМ КУАНЫШЕВНА",
        kz: "САДАКБАЕВА ГУЛИМ КУАНЫШЕВНА",
      },
      phone: "Вн. 201",
    ...
    },
    {
      ...
      category: "support",
      role: {
        ru: "Специалист по госзакупкам",
        kz: "Мемлекеттік сатып алу маманы",
      },
      name: {
        ru: "САТАЕВА ЗАРИНА АБДИНАСИЛОВНА",
        kz: "САТАЕВА ЗАРИНА АБДИНАСИЛОВНА",
      },
      phone: "Вн. 202",
    ...
    },
    {
      ...
      name: {
        ru: "ҚАЛДЫБАЙ ДӘУЛЕТ НҰРҒАЛИҰЛЫ",
        kz: "ҚАЛДЫБАЙ ДӘУЛЕТ НҰРҒАЛИҰЛЫ",
      },
      phone: "Вн. 203",
    ...
    },
    {
      ...
      name: {
        ru: "КУЛУНШАКОВ МУКСЫМХАН ЖАРАСОВИЧ",
        kz: "КУЛУНШАКОВ МУКСЫМХАН ЖАРАСОВИЧ",
      },
      phone: "Вн. 204",
      email: "ahch@gp33.kz",
      img: "https://via.placeholder.com/150",
  ...
  // Фильтрация
  const filteredList = administration.filter(
    (p) =>
    ...
    <div className="flex flex-col min-h-[60vh] bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        {filteredList.find((p) => p.id === "director") && (
          <div className="mb-12">
            {filteredList
              .filter((p) => p.id === "director")
              .map((person) => (
                <div
                  key={person.id}
                  className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100 flex flex-col md:flex-row"
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredList
              ...
              .map((person) => (
                <div
                  key={person.id}
                  className="bg-white rounded-lg shadow-md hover:shadow-xl transition border border-gray-100 p-6 flex flex-col group"
                >
                  <div className="flex items-center mb-4">
                    ...
                    <div>
                      <div
                        className={`text-[10px] font-bold uppercase leading-tight mb-1 ${
                          person.category === "head"
                            ? "text-blue-600"
                            : person.category === "support"
                              ? "text-green-600"
                              : "text-teal-600"
                        }`}
                      >
